...
reel geometry. Later demonstrations must be added as independently source-bound
slides rather than fake placeholders or hand-pinned media. The Agent Work Lab
video's poster, transcript, duration, and public evidence path are generated by
`scripts/import-auditable-demo.mjs` from the retained Passport and closed media
bundle. Only the active slide may play;
