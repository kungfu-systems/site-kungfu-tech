...
grep -Fq 'Generated from one signed Kungfu release channel' public/install.sh
grep -Fq 'Generated from one signed Kungfu release channel' public/install.ps1
grep -Fq 'update bootstrap-verify' public/install.sh
grep -Fq 'update bootstrap-verify' public/install.ps1
grep -Fq "version='4.0.0-alpha.3'" public/install.sh
